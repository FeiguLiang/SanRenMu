<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_add.aspx.cs" Inherits="admin_edit_add" validateRequest="false" %>
...
<head runat="server">
    <title>无标题页</title>
        <style type="text/css">
font  { font:normal 12px 宋体; }
</style>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <asp:Label ID="Label4" runat="server" Text="Label" Font-Names="宋体" Font-Size="12px">当前位置:添加文章</asp:Label><br />
        <hr /><br />
