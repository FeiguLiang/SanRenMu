<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_show.aspx.cs" Inherits="edit_show" %>
<%@ Register TagPrefix="page" TagName="footer" Src="~/ascx/footer.ascx" %>
<%@ Register TagPrefix="page" TagName="edit_wz" Src="~/ascx/edit_wz.ascx" %>
<%@ Register TagPrefix="page" TagName="guest" Src="~/ascx/guest.ascx" %>
<%@ Register TagPrefix="page" TagName="selectpage" Src="~/ascx/selectpage.ascx" %>
...
<page:edit_wz ID="edit_wz" runat="server" />
<p>
<page:selectpage ID="selectpage" runat="server" />
</p><p>
<page:guest ID="guest" runat="server" />
