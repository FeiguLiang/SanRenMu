<%@ Control Language="C#" AutoEventWireup="true" CodeFile="photo_show.ascx.cs" Inherits="ascx_photo_show" %>
...
<ItemTemplate>
<td>
<table border=1 bordercolor="#000000"><tr ><td><img src="updata/small/<%# Eval("photo_smallpath")  %>" alt="<%# Eval("photo_edit")  %>" /><br />
<a href="updata/<%# Eval("photo_bigpath")  %>" rel="lightbox[roadtrip]"><%# Eval("photo_name") %></a></td></tr></table></td>
</ItemTemplate>
<SeparatorTemplate>
</SeparatorTemplate>
