<%@ Control Language="C#" AutoEventWireup="true" CodeFile="guest_post.ascx.cs" Inherits="guest_post" %>
...
<tr>
<td width=100><font color="white"><%# Eval("post_count") %>楼：</font></td><td><table ><tr width=550><td width=150><font color="white">姓名:<%# Eval("post_name") %></font></td><td width=300><font color="white">QQ:<%# Eval("post_qq") %></font></td></tr></table></td>
</tr>
<tr >
<td width=100><font color="white">地址：</font></td><td><table><tr width=450><td width=150><font color="white">来自:<%# Eval("post_from") %></font></td><td width=350 ><font color="white">E-MAIL:<%# Eval("post_mail") %></font></td></tr></table></td>
</tr>
<tr width=600>
...
<tr>
<td width=50><font color="white">时间:</font></td><td width=350 ><font color="white"><%# Eval("post_time") %></font></td></table></td>
</tr></p>
</ItemTemplate>
<SeparatorTemplate>
</SeparatorTemplate>
...
</asp:DataList><br /><font color="white">
...
<table><tr><td><hr width=549/></td></tr></table>
<asp:Label ID="Label4" runat="server" Text=""></asp:Label><br />
<font color="write">请在这里写下您的留言 O(∩_∩)O~</font>
<table style="width: 549px;">
<tr>
<td width=80 ><font color="white">姓名:</font></td><td><table><tr><td style="height: 27px">
...
<td style="width: 88px" ><font color="white">来自:</font></td><td><table><tr><td style="height: 27px">
...
<td style="width: 349px">
    ...
    <br /><font color=red>*请不要输入任何非法字符串</font>
