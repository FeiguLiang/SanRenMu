<%@ Control Language="C#" AutoEventWireup="true" CodeFile="guest.ascx.cs" Inherits="guest" %>
...
<tr>
<td width=50><font color="white"><%# Eval("guest_count") %>楼：</font></td><td width=350 ><table><tr><td align="left" ><font color="white">姓名:<%# Eval("guest_name") %></font></td><td align="right" width=200><font color="white">联系方式:<%# Eval("guest_qq") %></font></td></tr></table></td>
</tr>
<p>
</p><p>
</p><p>
...
<tr>
<td width=50><font color="white">时间:</font></td><td width=350 ><font color="white"><%# Eval("guest_time") %></font></td></table></td>
</tr></p>
</ItemTemplate>
<SeparatorTemplate>
</SeparatorTemplate>
...
<br /><table><tr><td></td></tr><tr><td><hr width=549/></td></tr></table><br /><br />
