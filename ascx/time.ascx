<%@ Control Language="C#" AutoEventWireup="true" CodeFile="time.ascx.cs" Inherits="time" %>
...
</SCRIPT></td><td valign="top"><table><tr><td>
    <asp:Label ID="Label1" runat="server" Text="Label" ForeColor="White"></asp:Label></td></tr><tr><td>
        <asp:Label ID="Label3" runat="server" Text="Label" ForeColor="White"></asp:Label></td></tr><tr><td>
        <asp:Label ID="Label2" runat="server" Text="Label" ForeColor="White"></asp:Label></td></tr></table></td></tr>
</table>