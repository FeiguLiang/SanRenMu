<%@ Control Language="C#" AutoEventWireup="true" CodeFile="edit_show.ascx.cs" Inherits="edit_show" %>
...
<tr>
<td><h2><a href='edit_show.aspx?id=<%# Eval("edit_id")  %>&type=<%# Eval("edit_type")  %>'><%# Eval("edit_title") %></a>
</td>
</tr><tr>
